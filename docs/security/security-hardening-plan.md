...
The settings page may open only the fixed LanBridge GitHub project URL and a semver-validated Release page selected by the backend update checker. It does not accept arbitrary URLs from the frontend or from persisted settings.
